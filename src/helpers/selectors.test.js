import { getAppointmentsForDay, updateSpots, getInterview, getInterviewersForDay } from "helpers/selectors";
...
test("getInterviewersForDay returns an array containing the correct interviewers for that day", () => {
